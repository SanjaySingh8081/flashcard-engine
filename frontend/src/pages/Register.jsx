...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      {/* ── Orbs ── */}
      <div
        className="orb-pulse-1 absolute -top-24 -right-24 w-[480px] h-[480px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, #4f46e5 0%, transparent 70%)', filter: 'blur(60px)' }}
      />
      <div
        className="orb-pulse-2 absolute -bottom-32 -left-16 w-[520px] h-[520px] rounded-full pointer-events-none"
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, #5b21b6 0%, transparent 70%)', filter: 'blur(90px)' }}
      />
      ...
      <FloatingCard
        ...
        back="A spaced repetition algorithm that optimises review intervals based on recall quality."
      />
      <FloatingCard
        className="bottom-[15%] left-[2%] hidden xl:block z-0"
        floatClass="float-c"
        front="What is DNA replication?"
        back="The biological process of producing two identical copies of DNA from one original molecule."
      />
      <FloatingCard
        className="top-[12%] right-[2%] hidden xl:block z-0"
        floatClass="float-b"
        front="Explain Big O notation"
        back="A mathematical notation describing the limiting behaviour of a function as input grows."
      />
      <FloatingCard
        className="bottom-[15%] right-[2%] hidden xl:block z-0"
        floatClass="float-d"
        front="What is Ohm's Law?"
        back="Voltage equals current multiplied by resistance: V = IR."
      />
      ...
      >
        ...
        <div className="mb-7">
          ...
          <p className="text-white/50 text-sm mt-1.5">Free forever — no credit card needed</p>
        </div>
